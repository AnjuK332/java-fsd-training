//finding the similar elements from two arrays and sort that resultant array in BubbleSort method using Arraylist.
package training_java_datastructure;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.Scanner;

public class BubbleSortSimilarArraylist {
